...
| ADR-005 | Runtime/cloud | ACCEPTED |
| ADR-006 | Secrets | ACCEPTED |
| ADR-007 | Metric computation | ACCEPTED |
| ADR-008 | Audit ledger | ACCEPTED |
| ADR-009 | Observability | ACCEPTED |
| ADR-010 | Identity/Auth | ACCEPTED |
