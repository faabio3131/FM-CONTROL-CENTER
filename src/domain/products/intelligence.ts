...
export const PRODUCT_INTELLIGENCE_TARGETS: readonly ProductMetricTarget[] = [
  { category: "acquisition", metricId: "lead.created.count", displayName: "Potenciais clientes criados", definitionStatus: "pending_semantics" },
  ...
  { category: "engagement", metricId: "usage.active_users.dau", displayName: "Usuários ativos diários (DAU)", definitionStatus: "pending_semantics" },
  ...
  { category: "health", metricId: "support.ticket.open.count", displayName: "Chamados de suporte abertos", definitionStatus: "pending_semantics" },
] as const;
