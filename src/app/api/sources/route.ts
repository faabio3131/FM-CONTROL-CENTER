...
export async function POST(request: Request) {
  try {
    ...
    const body = await request.json() as {
      name?: unknown; sourceType?: unknown; authoritativeDomain?: unknown; syncMode?: unknown;
    ...
    const source = await new SourceRegistryService(new PostgresSourceRepository()).register(context, {
