...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(await buildAlertService().archiveRule(context, body.ruleId));
  } catch (error) {
    ...
    if (error instanceof AlertRuleMustBeDisabledError) {
